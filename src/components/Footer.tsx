          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
            <div>
              ...
              <p className="text-sm text-background/60 leading-relaxed">
                Архитектурный бетон ручной работы в Гродно. Столешницы, раковины, барные стойки и другие изделия для вашего интерьера.
              </p>
            </div>
            <div>
          ...
          <div className="flex gap-4">
            {[
              ...
              <button
                key={item.label}
                type="button"
                className="relative group text-background/60 cursor-default"
                aria-label={`${item.label} (скоро)`}
                aria-disabled="true"
              >
                <span className="pointer-events-none">{item.icon}</span>
                <span className="pointer-events-none absolute -bottom-5 left-1/2 -translate-x-1/2 text-[10px] uppercase tracking-[0.2em] text-background/60 opacity-0 group-hover:opacity-100 transition-opacity">
                  soon
                </span>
              </button>
            ))}
